                        ...
                        <li class="faq-list__item " data-js="accordion_item">
                            ...
                            <div class="faq-list__answer" data-js="accordion_content" id="answerId1" style="">
                                <div class="answer__wrap">
                                    ...
                                    <div class="answer__box">회원 탈퇴시에는 고객님의 활동 내역, 고객정보 등이 모두 삭제됩니다.</div>
                                </div>
                            </div>
                        </li>
                    </ul>
                        ...
                        <li class="faq-list__item " data-js="accordion_item">
                            ...
                            <div class="faq-list__answer" data-js="accordion_content" id="answerId1" style="">
                                <div class="answer__wrap">
                                    ...
                                    <div class="answer__box">회원정보 수정은 MY 페이지를 통해 수정 가능합니다.<br>
                                        1. 프로필 사진 변경, 비밀번호 변경, 닉네임 변경이 가능합니다.<br>
                                        2. 한번 등록된 아이디는 수정 또는 변경이 어렵습니다.
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="faq-list__item " data-js="accordion_item">
                            ...
                            <div class="faq-list__answer" data-js="accordion_content" id="answerId1" style="">
                                <div class="answer__wrap">
                                    ...
                                    <div class="answer__box">홈페이지 상단에 로그인 클릭하신 후 회원가입 버튼을 눌러 개인정보 이용약관에 동의하신 후<br>
                                        간단한 개인정보를 입력하여 가입하신 후 서비스를 이용하실 수 있습니다.
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="faq-list__answer" data-js="accordion_content" id="answerId1" style="">
                                <div class="answer__wrap">
                                    ...
                                    <div class="answer__box">1. 이벤트는 이벤트 응모 후 사이트내 당첨공지가 진행되는 이벤트가 있습니다.<br>
                                        2. 이벤트 응모 후 당첨 확인은 사이트내 공지사항 또는 이벤트 게시판에서 확인 가능합니다.<br>
                                        3. 당첨공지 후 해당 이벤트 확인 기간 내에 [확인]을 꼭 해주세요.
                                    </div>
                                </div>
                            </div>
                        </li>
